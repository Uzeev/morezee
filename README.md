...
1. Navigate to the `.github/workflows/Uzeev.yml` file in your repository.
2. Edit the file, replacing `"uzee.d.portgas@gmail.com"` with your email and `"dante4rt"` with your GitHub username in the `Setup Git Configuration` step.
